...
<div class="container">
  <div class="row">
    <div class="col-4 ">
<form action="/filternaiset" method="get" oninput="z1.value=minhinta.value; z2.value=maxhinta.value">
...
<p></p>
    ...
    <div class="col-8 ">
      <div class="row">
    <div class="col-sm">
    @foreach ($filternaiset as $filterednaiset)
    
    <div class="col-sm border border-dark">
    <img src="tuotekuvat/{{ $filterednaiset->tuotteenkuva }}" style="max-width:200px"> {{ $filterednaiset->tuotteennimi }} <br>{{ $filterednaiset->hinta }} € <a href='#'class="btn btn-success lisaa" id="{{ $filterednaiset->TuoteID }}">Lisaa Ostoskoriin</a> 
</div> <br>
