...
<p>Hinta:</p>
  ...
  <p></p><button class="btn btn-primary" type="submit">Etsi</button>
</form>
<p></p>
        </div> 
    </div>
    ...
    <img src="tuotekuvat/{{ $filtered->tuotteenkuva }}" style="max-width:200px"> {{ $filtered->tuotteennimi }} <br>{{ $filtered->hinta }} € <a href='#'class="btn btn-success lisaa" id="{{ $filtered->TuoteID }}">Lisaa Ostoskoriin</a> 
</div> <br>
