...
<p>Hinta:</p>
  ...
  <p></p>
<button class="btn btn-primary" data-inline="true" type="submit">Etsi</button>
</form>
<p></p>
        </div> 
    </div>
    <div class="col-8 ">
      <div class="row">
    <div class="col-sm">
    @foreach ($naiset as $nainen)
    
    <div class="col-sm border border-dark">
    <img src="tuotekuvat/{{ $nainen->tuotteenkuva }}" style="max-width:200px"> {{ $nainen->tuotteennimi }} <br>{{ $nainen->hinta }} € <a href='#'class="btn btn-success lisaa" id="{{ $nainen->TuoteID }}">Lisaa Ostoskoriin</a> 
</div> <br>
