...
<p></p>
    ...
    <div class="col-8 ">
      <div class="row">
    <div class="col-sm">
    @foreach ($miehet as $mies)
    
    <div class="col-sm border border-dark">
    <img src="tuotekuvat/{{ $mies->tuotteenkuva }}" style="max-width:200px"> {{ $mies->tuotteennimi }} <br>{{ $mies->hinta }} € <a href='#'class="btn btn-success lisaa" id="{{ $mies->TuoteID }}">Lisaa Ostoskoriin</a> 
</div> <br>
